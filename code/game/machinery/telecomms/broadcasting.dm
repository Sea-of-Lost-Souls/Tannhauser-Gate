...
/datum/signal/subspace/vocal/New(
	...
	lvls = null, // TANNHAUSER ADDITION -- NTSL -- what z-levels is this message broadcast to?
)
	src.source = source
	...
	// levels = SSmapping.get_connected_levels(get_turf(source)) -- TANNHAUSER EDIT OLD
	levels = lvls != null ? lvls : SSmapping.get_connected_levels(get_turf(source)) // TANNHAUSER EDIT NEW
