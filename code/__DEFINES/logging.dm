...
#define LOG_NTSL (1 << 23) // TANNHAUSER ADDITION -- NTSL (could be put into tannhauser NTSL defines, but here is safer)
...
// TANNHAUSER ADDITION -- NTSL -- added LOG_NTSL in the upper line
